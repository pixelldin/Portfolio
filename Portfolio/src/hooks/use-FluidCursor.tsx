...
const useFluidCursor = (customConfig?: FluidCursorConfig) => {
  ...
  return () => {
    ...
    if (window.removeEventListener) {
      ...
      window.removeEventListener('mousedown', window.mousedownHandler);
      window.removeEventListener('touchstart', window.touchstartHandler);
      window.removeEventListener('touchmove', window.touchmoveHandler);
      window.removeEventListener('touchend', window.touchendHandler);
    }
  };
};
